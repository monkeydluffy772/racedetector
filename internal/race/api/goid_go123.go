...
//go:build go1.23 && !go1.24 && (amd64 || arm64)

// Go 1.23 specific goid extraction.
//
// In Go 1.23, the gobuf struct is 56 bytes (7 pointers), placing goid at offset 160.
//
// g struct layout (Go 1.23):
//
//	Field          Size    Offset
//	-----          ----    ------
//	stack          16      0
...
// goidOffset for Go 1.23 is 160 bytes.
